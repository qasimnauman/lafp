...
const SidebarUser = () => {
  ...
  const menuItems = [
    { label: "Dashboard", icon: <LayoutDashboard size={18} />, to: "/user" },
    { label: "Items", icon: <Boxes size={18} />, to: "/user/myitems" },
    { label: "Claims", icon: <BadgeCheck size={18} />, to: "/user/claims" },
    {
      label: "Profile",
      icon: <Users size={18} />,
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 left-0 h-full w-64 bg-white text-gray-800 shadow-md flex flex-col justify-between transform transition-transform duration-300 ease-in-out z-40 md:translate-x-0 ${
